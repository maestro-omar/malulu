export function hasPermission(props, permission, schoolId = null) {
    ...
    return props.auth.user.permissionBySchool[permission].includes(schoolId) || props.auth.user.permissionBySchool[permission].includes(props.constants.schoolGlobalId);
} 