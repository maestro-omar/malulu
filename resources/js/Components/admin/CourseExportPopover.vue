    ...
    <div class="course-export-popover" ref="popoverRef">
        ...
        <div v-if="isOpen" class="course-export-popover__content">
            ...
            <div class="course-export-popover__header">
                ...
                <button @click="closePopover" class="course-export-popover__close">
            ...
            <div class="course-export-popover__actions">
                <button @click="closePopover" class="course-export-popover__btn course-export-popover__btn--cancel">
                    Cancelar
                </button>
                <button @click="handleExport" :disabled="!hasSelectedOptions" 
                    class="course-export-popover__btn course-export-popover__btn--export">
                    Exportar
                </button>
            </div>
        </div>
