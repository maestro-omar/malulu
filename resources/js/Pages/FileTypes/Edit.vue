<template>
  ...
  <AuthenticatedLayout>
    ...
    <template #admin-header>
      <AdminHeader :title="` Editar Tipo de Archivo: ${props.fileType.name}`"></AdminHeader>
    </template>
      ...
      <div class="container">
        <div class="admin-form__wrapper">
          <form @submit.prevent="submit" class="admin-form__container">
              ...
              <q-card-section>
                <div class="admin-form__card-content">
                  ...
                  <div class="admin-form__field">
                    ...
                    <select id="relate_with" v-model="form.relate_with" class="admin-form__select">
            ...
            <ActionButtons button-label="Guardar" :cancel-href="route('file-types.index')"
