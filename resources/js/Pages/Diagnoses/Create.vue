<template>
  ...
  <AuthenticatedLayout>
    <template #admin-header>
      <AdminHeader :title="`Nuevo Diagnóstico`"></AdminHeader>
    </template>
      ...
      <div class="container">
        <div class="admin-form__wrapper">
          <form @submit.prevent="submit" class="admin-form__container">
                ...
                <div class="admin-form__card-content">
                  <div class="admin-form__field">
                    ...
                    <TextInput type="text" id="code" v-model="form.code"
                      class="admin-form__input" placeholder="Ej: F84.0" />
                  ...
                  <div class="admin-form__field">
                    ...
                    <TextInput type="text" id="name" v-model="form.name"
                      class="admin-form__input" placeholder="Ej: Trastorno del espectro autista" required />
            ...
            <ActionButtons button-label="Crear Diagnóstico" :cancel-href="route('diagnoses.index')"
