              ...
              <form @submit.prevent="onSubmit">
                ...
                <div class="admin-form__actions">
                  <ActionButtons 
                    ...
                    :cancel-href="route('provinces.file.show', { 'province': province.id, 'file': file.id })"
                  />
                </div>
              </form>
            </div>
...
const onSubmit = () => {
  if (form.inputType === 'file' && form.file) {
    ...
    form.post(route('provinces.file.replace', { 'province': props.province.id, 'file': props.file.id }), {
      forceFormData: true
    })
