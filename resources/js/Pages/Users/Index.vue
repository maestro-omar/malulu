            ...
            <div class="table__wrapper">
                <div class="table__container">
                    ...
                    <div class="table__search">
                        <input type="text" v-model="search" @input="handleSearch" placeholder="Buscar usuarios..." />
                        ...
                        <table class="table__table">
                            <thead class="table__thead">
                                <tr>
                                    ...
                                    <th :class="['table__th', 'table__th--sortable', getSortClass('name')]"
                                        @click="handleSort('name')">
                                        Nombre
                                    </th>
                                    <th :class="['table__th', 'table__th--sortable', getSortClass('email')]"
                            ...
                            <tbody class="table__tbody">
                                <tr v-for="(user, index) in users.data" :key="user.id" :class="{
                                    ...
                                    <td class="table__td table__schools">
                                        <span v-for="school in user.schools" :key="school.id" class="table__badge"
                                            :title="school.name">
                                            {{ school.short }}
                                        </span>
                                    </td>
                    ...
                    <div class="table__mobile">
                        <div v-for="(user, index) in users.data" :key="user.id" :class="{
                            ...
                            <div class="table__card-section">
                                ...
                                <div class="table__card-content">
                                    <RoleBadge v-for="role in getUniqueRoles(user.roles)" :key="role.id" :role="role" />
                                </div>
                            </div>
                        </div>
                    </div>
