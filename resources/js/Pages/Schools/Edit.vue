<template>
  ...
  <AuthenticatedLayout>
    <template #admin-header>
      <AdminHeader :title="`Editar Escuela: ${school.name}`">
      </AdminHeader>
    </template>
              ...
              <q-card-section>
                <div class="admin-form__card-content">
                  <div class="admin-form__grid admin-form__grid--2">
                      ...
                      <div class="admin-form__card-content">
                        ...
                        <div class="admin-form__grid admin-form__grid--3">
                          <div class="admin-form__field">
                            ...
                            <InputError :message="form.errors.short" class="admin-form__error" />
                          </div>

                          <div class="admin-form__field">
                            <InputLabel for="slug" value="Slug" />
                            <TextInput id="slug" type="text" class="admin-form__input" v-model="form.slug" required />
                            <InputError :message="form.errors.slug" class="admin-form__error" />
                          </div>

                          <div class="admin-form__field">
                            <InputLabel for="cue" value="CUE" />
                            <TextInput id="cue" type="text" class="admin-form__input" v-model="form.cue" required />
                            <InputError :message="form.errors.cue" class="admin-form__error" />
                          </div>
                        </div>
                        ...
                        <div class="admin-form__grid admin-form__grid--2">
                          <div class="admin-form__field">
                            ...
                            <InputError :message="form.errors.management_type_id" class="admin-form__error" />
                          </div>
                        </div>
                        ...
                        <div class="admin-form__grid admin-form__grid--2">
                          <div class="admin-form__field">
                            ...
                            <InputError :message="form.errors.school_levels" class="admin-form__error" />
                          </div>
                          ...
                          <div class="admin-form__field">
                            ...
                            <InputError :message="form.errors.shifts" class="admin-form__error" />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      <h3 class="admin-form__card-title">Ubicación y Contacto</h3>
                      <div class="admin-form__card-content">
                        <div class="admin-form__field">
                          ...
                          <InputError :message="form.errors.locality_id" class="admin-form__error" />
                        </div>
                        ...
                        <div class="admin-form__grid admin-form__grid--2">
                          <div class="admin-form__field">
                            ...
                            <InputError :message="form.errors.zip_code" class="admin-form__error" />
                          </div>

                          <div class="admin-form__field">
                            <InputLabel for="coordinates" value="Coordenadas" />
                            <TextInput id="coordinates" type="text" class="admin-form__input" v-model="form.coordinates"
                              placeholder="Ej: -33.3017,-66.3378" />
                            <InputError :message="form.errors.coordinates" class="admin-form__error" />
                          </div>
                        </div>
                        ...
                        <div class="admin-form__grid admin-form__grid--2">
                          <div class="admin-form__field">
                            ...
                            <InputError :message="form.errors.phone" class="admin-form__error" />
                          </div>

                          <div class="admin-form__field">
                            <InputLabel for="email" value="Email" />
                            <TextInput id="email" type="email" class="admin-form__input" v-model="form.email" />
                            <InputError :message="form.errors.email" class="admin-form__error" />
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="admin-form__section">
                    ...
                    <div class="admin-form__card-content">
                      <div v-for="(social, index) in form.social" :key="index" class="admin-form__social-grid">
                        <div class="admin-form__social-type">
                          <InputLabel :value="'Tipo'" />
                          <select v-model="social.type" class="admin-form__select">
                        ...
                        <div class="admin-form__social-label">
                          <InputLabel :value="'Etiqueta'" />
                          <TextInput type="text" class="admin-form__input" v-model="social.label"
                            :placeholder="social.type === 'other' ? 'Nombre de la red' : ''" />
                        </div>
                        <div class="admin-form__social-link">
                          <InputLabel :value="'Enlace'" />
                          <TextInput type="url" class="admin-form__input" v-model="social.link"
                            placeholder="https://..." />
                        </div>
                      ...
                      <div class="admin-form__field">
                        <button type="button" @click="addSocial"
                          class="admin-form__button admin-form__button--secondary">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd"
...
const submit = () => {
  ...
  form.put(route('school.update', props.school.slug), {
    preserveScroll: true,
    onError: (errors) => {
