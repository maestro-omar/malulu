                ...
                <div class="space-y-4">
                  ...
                  <div class="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p class="mt-1 text-sm text-gray-900">{{ school.short }}</p>
                    </div>
                  ...
                  <div>
                    <label class="block text-sm font-medium text-gray-700">Niveles</label>
                  ...
                  <div>
                    <label class="block text-sm font-medium text-gray-700">Turnos</label>
                    <div class="mt-2 flex flex-wrap gap-2">
              ...
              <div>
                ...
                <div class="space-y-4">
                  <div>
                    ...
                    <p class="mt-1 text-sm text-gray-900">{{ school.locality.name }}</p>
                  </div>

                  <div>
                    <label class="block text-sm font-medium text-gray-700">Dirección</label>
                    <p class="mt-1 text-sm text-gray-900">{{ school.address }}</p>
                  </div>

                  <div class="grid grid-cols-2 gap-4">
                    <div>
                      <label class="block text-sm font-medium text-gray-700">Código Postal</label>
                      <p class="mt-1 text-sm text-gray-900">{{ school.zip_code }}</p>
                    </div>

                    <div>
                      <label class="block text-sm font-medium text-gray-700">Coordenadas</label>
                      <div class="flex items-center space-x-2">
                        <p class="mt-1 text-sm text-gray-900">{{ school.coordinates }}</p>
                        <a 
