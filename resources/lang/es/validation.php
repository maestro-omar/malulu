...
return [
    ...
    | mensajes según las necesidades de tu aplicación.
    |
    */
    ...
    | específicos usando la convención "atributo.regla" para nombrar las líneas.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Reemplazo de nombres de atributos
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se utilizan para intercambiar nombres de atributos
    | por algo más amigable para el lector.
    |
    */
