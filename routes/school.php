...
Route::prefix(__('routes.system') . '/escuela/{school}')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::put(__('routes.student') . '/{idAndName}/' . __('routes.edit'), [UserController::class, 'studentUpdate'])->name('school.student.update');
        ...
        Route::get('{schoolLevel}/' . __('routes.courses') . '/{course}', [CourseController::class, 'show'])->name('courses.show')->middleware('school.permission:course.manage');
