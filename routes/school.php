...
Route::prefix(__('routes.system') . '/escuela/{school}')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::get(__('routes.staff') . '/{idAndName}', [UserController::class, 'staff'])->name('school.staff.show')->middleware('school.permission:partner.view');
        ...
        Route::post('{schoolLevel}/' . __('routes.course') . '/{idAndLabel}/' . __('routes.export'), [CourseController::class, 'export'])->name('school.course.export')->middleware('school.permission:course.manage');
